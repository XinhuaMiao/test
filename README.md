...
We have preprocessed two raw datasets, you can obtain the well-preprocessed datasets from an anonymous repository [STAR](https://anonymous.4open.science/r/STAR-26) and place them in the following folder. 

D1: STAR-main/data/D1

D2: STAR-main/data/D2
...
To train and evaluate the STAR model, please run the following command:

```
# running STAR method for AD, FT, and RCL tasks on D1 dataset
python main.py --workflow AD FT RCL --dataset D1
```

Evaluation will be automatically performed after training is completed, and the running time of each task will be automatically calculated and displayed.
